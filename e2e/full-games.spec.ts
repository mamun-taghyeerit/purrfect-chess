...
test.describe('Full Game Replays', () => {
  ...
  test('should replay Fool\'s Mate (2 moves - fastest checkmate)', async ({ page }) => {
  ...
  test('should replay Traxler Counter Attack into checkmate', async ({ page }) => {
  ...
  test('should handle rapid move sequences without errors', async ({ page }) => {

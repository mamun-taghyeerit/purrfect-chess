 ...
 * 
 * @param {Object} timeControl - Time control configuration
 * @param {number} timeControl.minutes - Total minutes per player
 * @param {number} [timeControl.increment] - Increment in seconds (optional)
 * @returns {number} Recommended engine depth (18 or 22)
 */
export function computeEvalDepth(timeControl) {
 ...
 * @returns {string} Formatted time string (e.g., "3.50s/600.00")
 */
export function formatRemainingTime(seconds, total) {

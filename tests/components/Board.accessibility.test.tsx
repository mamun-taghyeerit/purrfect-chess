...
describe('Board Accessibility', () => {
  ...
  describe('ARIA attributes', () => {
    ...
    it('should update aria-label when square is selected', () => {
      ...
      const e2Square = document.querySelector(
        '[data-square="e2"]'
      ) as HTMLElement;
    ...
    it('should mark legal moves in aria-label', () => {
      ...
      const e3Square = document.querySelector(
        '[data-square="e3"]'
      ) as HTMLElement;
  ...
  describe('Keyboard navigation', () => {
    ...
    it('should navigate with arrow keys', () => {
      ...
      const f2Square = document.querySelector(
        '[data-square="f2"]'
      ) as HTMLElement;
    ...
    it('should navigate left with ArrowLeft', () => {
      ...
      const d2Square = document.querySelector(
        '[data-square="d2"]'
      ) as HTMLElement;
    ...
    it('should not navigate beyond board boundaries', () => {
      ...
      const a2Square = document.querySelector(
        '[data-square="a2"]'
      ) as HTMLElement;
